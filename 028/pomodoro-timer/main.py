...
start_button = Button(text='Start', highlightthickness=0, font=(FONT_NAME, 15, "bold"), command=start_timer)
start_button.grid(column=1, row=3)


reset_button = Button(text='Reset', highlightthickness=0, font=(FONT_NAME, 15, "bold"), command=reset_timer)
