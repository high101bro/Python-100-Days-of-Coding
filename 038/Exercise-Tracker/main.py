...
GOOGLE_SHEET_NAME = "Exercise"
sheet_endpoint = "https://api.sheety.co/d606d33dcf1944959704afb9530c3c97/exercise/workouts"
...
for exercise in result["exercises"]:
    ...
    bearer_headers = {
        "Authorization": f"Bearer {os.environ['SHEETLY_EXERCISE_BEARER_TOKEN']}"
    }
    sheet_response = requests.post(
        sheet_endpoint,
        json=sheet_inputs,
